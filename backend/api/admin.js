...
const deviceRepresentation = ({ deviceId, createdAt, updatedAt, deviceType, calendarId, language, clockType, minutesForCheckIn }) => ({
  id: deviceId,
  createdAt,
  deviceType,
  calendarId,
...
const userRepresentation = ({ displayName, photoUrl, email }) => ({ displayName, email, avatarUrl: photoUrl });
